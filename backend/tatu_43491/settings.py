"""
Django settings for tatu_43491 project.
...
WSGI_APPLICATION = 'tatu_43491.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tatu_43491 API",
    "DESCRIPTION": "API documentation for tatu_43491 App",
    "VERSION": "v1",
}
